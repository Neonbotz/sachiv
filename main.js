...
async function connectionUpdate(update) {
  ...
  if (update.receivedPendingNotifications) conn.sendMessage(`6287719424487@s.whatsapp.net`, {text: 'Sukses Connect Owner Ku Yang Ganteng😸' }) //made by Muhammad Ridwan Reynaldy 
}
